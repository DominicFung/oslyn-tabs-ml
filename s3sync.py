...
AWS_S3SYNC_PROFILE = "a1"
AWS_S3_SYNC_COMMAND = "aws s3 sync --storage-class REDUCED_REDUNDANCY --delete --exact-timestamps {leftPath} {rightPath} --profile {AWS_S3SYNC_PROFILE}"
